...
abstract class UeditorUpload
{
    ...
    protected function getFullName()
    {
        ...
        $format = str_replace("{userid}", 'user_' . (Auth::check() ? Auth::user()->id : 'custom'), $format);
        $format = str_replace("{orgid}", 'org_' . (Auth::check() ? Auth::user()->orgID() : 'custom'), $format);
    ...
    protected function getFilePath()
    {
        ...
        $rootPath = $this->config['prefixUrl'];
